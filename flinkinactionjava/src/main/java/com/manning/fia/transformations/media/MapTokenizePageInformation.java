...
public class MapTokenizePageInformation implements MapFunction<PageInformation, Tuple3<String, String, Long>> {
    @Override
    public Tuple3<String, String, Long> map(PageInformation pageInformation) throws Exception {
