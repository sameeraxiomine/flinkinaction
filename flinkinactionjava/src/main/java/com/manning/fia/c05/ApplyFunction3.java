...
public class ApplyFunction3 implements WindowFunction<
        BaseNewsFeed,
    ...
    public void apply(Tuple2<String, String> key,
        ...
        Iterator<BaseNewsFeed> iter = inputs.iterator();
        while (iter.hasNext()) {
            BaseNewsFeed input = iter.next();
            if (input instanceof NewsFeed) {
