 ...
 */
public class TumblingEventTimeUsingPeriodicWM {
    public void executeJob(ParameterTool parameterTool) throws Exception {
        ...
        result.print();
        execEnv.execute("Tumbling Event Time Window Using Periodic WM");
    }  
    
    public static void main(String[] args) throws Exception {
        ParameterTool parameterTool = ParameterTool.fromArgs(args);
        TumblingEventTimeUsingPeriodicWM window = new TumblingEventTimeUsingPeriodicWM();
