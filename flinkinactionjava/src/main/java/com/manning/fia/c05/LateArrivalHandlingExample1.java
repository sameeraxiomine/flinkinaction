...
public class LateArrivalHandlingExample1 {
	public static void main(String[] args) throws Exception{
		...
		data.add(Tuple4.of(0,3, 1,2999l));
		data.add(Tuple4.of(0,4, 1,2999l));
		data.add(Tuple4.of(0,5, 1,199l));
		//data.add(Tuple4.of(0,0, 1,99l));
		...
		execEnv.execute("Late Events Handled");
	}
