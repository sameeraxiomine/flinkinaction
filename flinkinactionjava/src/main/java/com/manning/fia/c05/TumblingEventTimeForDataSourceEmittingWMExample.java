 ...
 *
 */
public class TumblingEventTimeForDataSourceEmittingWMExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        TumblingEventTimeForDataSourceEmittingWMExample window = new TumblingEventTimeForDataSourceEmittingWMExample();
